    ...
    <div className="min-h-screen p-4 text-white">
      ...
      <AnimatePresence>
        {showUploadArea && (
          ...
          >
            <div className="flex flex-col items-center justify-center py-20 border-2 border-dashed border-gray-600 rounded-xl bg-purple-900/20 relative">
              <FiUpload className="w-16 h-16 text-purple-500 mb-4" />
              <p className="text-gray-300 mb-4">{t('selectFiles')}</p>
              <input
                type="file"
              ...
              <button
                ...
                className="absolute top-2 right-2 text-gray-400 hover:text-white p-2 bg-purple-900/50 rounded-full"
              >
                <FiX />
              </button>
            </div>
          ...
          <AnimatePresence>
            {files.map((file, i) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, x: -10 }}
                className="bg-purple-900/20 rounded-lg p-4 flex items-center justify-between group hover:bg-purple-900/30 transition-colors"
              >
