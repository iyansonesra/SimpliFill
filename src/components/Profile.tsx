...
const Input = ({ label, name, type = 'text', value, onChange }) => (
  <div>
    ...
    <input
      ...
      value={value}
      onChange={onChange}
      className="w-full bg-black bg-gradient-to-br from-black via-purple-900/20  border border-purple-600 rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
    />
  </div>
);
